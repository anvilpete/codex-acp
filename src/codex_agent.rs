use acp::schema::{
    ...
    ClientCapabilities, CloseSessionRequest, CloseSessionResponse,
    CreateElicitationRequest, ElicitationAction, ElicitationRequestScope, ElicitationUrlMode,
    Implementation,
    ...
    NewSessionResponse, PromptCapabilities, PromptRequest, PromptResponse, ProtocolVersion, RequestId,
